...
## Likely Data Source
I will explore **PSA OpenSTAT — Labor Force Survey (Labor and Employment category) for national underemployment rate** (https://openstat.psa.gov.ph/Database/Labor-and-Employment), **PSA OpenSTAT — National Accounts of the Philippines (GDP)** (https://openstat.psa.gov.ph/Database/Economic-Accounts/National-Accounts-of-the-Philippines/Annual-National-Accounts), **PSA OpenSTAT — Consumer Price Index for All Income Households** (https://openstat.psa.gov.ph/PXWeb/pxweb/en/DB/DB__2M__PI__CPI__2018/?tablelist=true)
